...
```text
lw.PPOCR.OpenCVDNN-v0.7.0-linux-arm64-uos20.tar.gz
lw.PPOCR.OpenCVDNN-v0.7.0-linux-arm64-uos20.tar.gz.sha256
```
...
sha256sum -c lw.PPOCR.OpenCVDNN-v0.7.0-linux-arm64-uos20.tar.gz.sha256
tar -xzf lw.PPOCR.OpenCVDNN-v0.7.0-linux-arm64-uos20.tar.gz
cd lw.PPOCR.OpenCVDNN-v0.7.0-linux-arm64-uos20
