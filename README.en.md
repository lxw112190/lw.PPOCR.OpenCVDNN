...
> Current stable release: `v1.1.0`. C ABI v1, HTTP API v1,
...
`v1.1.0` provides the stable `linux/amd64` image. After the tag is published:
...
- [v1.1.0 stable release notes](docs/releases/v1.1.0.md)
