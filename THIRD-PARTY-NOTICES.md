...
| --- | --- | --- |
| OpenCV | Image processing and DNN inference | Apache-2.0 |
| cpp-httplib | Embedded HTTP server | MIT |
| nlohmann/json | JSON parsing and serialization | MIT |
| spdlog | Runtime and request logging | MIT |
